...
/**
**/
@:require(js, hxelectron) @:jsRequire("electron", "clipboard") extern class Clipboard
{
	 ...
	 */
	static function readBookmark() : { @:optional var title : String; @:optional var url : String; };
	/**
	 ...
	 */
	static function write(data:{ @:optional var text : String; @:optional var html : String; @:optional var image : NativeImage; @:optional var rtf : String; /**
	 The title of the url at text.
	 */
	@:optional var bookmark : String; }, ?type:String) : Void;
}