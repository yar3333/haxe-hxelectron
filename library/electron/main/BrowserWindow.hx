...
@:require(js, hxelectron) @:jsRequire("electron", "BrowserWindow") extern class BrowserWindow extends js.node.events.EventEmitter<electron.main.BrowserWindow> {
	...
	**/
	...
	function new(?options:BrowserWindowConstructorOptions):Void;
	/**
	...
	**/
	function getNormalBounds():Rectangle;
	/**
	...
	**/
	function setShape(rects:Array<Rectangle>):Void;
	/**
	...
	**/
	function addBrowserView(browserView:BrowserView):Void;
	function removeBrowserView(browserView:BrowserView):Void;
	/**
		Raises `browserView` above other `BrowserView`s attached to `win`. Throws an error if `browserView` is not attached to `win`.
	**/
	function setTopBrowserView(browserView:BrowserView):Void;
	/**
	...
	**/
	function getBrowserViews():Array<BrowserView>;
	/**
...
@:require(js, hxelectron) enum abstract BrowserWindowEvent(String) from String to String {
	...
	**/
	var will_resize : String = "will-resize";
	/**
	...
	**/
	var resized : String = "resized";
	/**
		Emitted before the window is moved. On Windows, calling `event.preventDefault()` will prevent the window from being moved.
		
		Note that this is only emitted when the window is being moved manually. Moving the window with `setPosition`/`setBounds`/`center` will not emit this event.
	**/
	var will_move : String = "will-move";
	/**
	...
	**/
	var always_on_top_changed : String = "always-on-top-changed";
	/**
	...
	**/
	var rotate_gesture : String = "rotate-gesture";
	/**
	...
	**/
	var system_context_menu : String = "system-context-menu";
}