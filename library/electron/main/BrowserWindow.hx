...
**/
@:require(js, hxelectron) @:jsRequire("electron", "BrowserWindow") extern class BrowserWindow extends js.node.events.EventEmitter<electron.main.BrowserWindow>
{
	/**
	 ...
	 */
	@:optional var parent : BrowserWindow; /**
	 ...
	 */
	@:optional var titleBarStyle : String; /**
	 ...
	 */
	@:optional var zoomToPageWidth : Bool; /**
	 Tab group name, allows opening the window as a native tab on macOS 10.12+. Windows with the same tabbing identifier will be grouped together.
	 */
	@:optional var tabbingIdentifier : String; /**
	 Settings of web page's features.
	 */
	@:optional var webPreferences : { /**
	 ...
	 */
	@:optional var nodeIntegrationInWorker : Bool; /**
	 ...
	 */
	@:optional var scrollBounce : Bool; /**
	 ...
	 */
	@:optional var disableBlinkFeatures : String; /**
	 Sets the default font for the font-family.
	 */
	@:optional var defaultFontFamily : { /**
	...
	@:optional var monospace : String; /**
	 Defaults to Script.
	 */
	@:optional var cursive : String; /**
	 Defaults to Impact.
	 */
	@:optional var fantasy : String; }; /**
	 Defaults to 16.
	 */
	 ...
	 */
	@:optional var contextIsolation : Bool; }; }) : Void;
	/**
	 ...
	 */
	@:optional var extraHeaders : String; @:optional var postData : Dynamic; /**
	 ...
	 */
	@:optional var baseURLForDataURL : String; }) : Void;
	/**
	...
	@:optional var appId : String; /**
	 Window's .
	 */
	@:optional var appIconPath : String; /**
	 Index of the icon in appIconPath. Ignored when appIconPath is not set. Default is 0.
	 */
	@:optional var appIconIndex : Int; /**
	 Window's .
	 */
	@:optional var relaunchCommand : String; /**
	 Window's .
	 */
	@:optional var relaunchDisplayName : String; }) : Void;
	/**
