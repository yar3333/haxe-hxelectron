...
**/
@:require(js, hxelectron) @:jsRequire("electron", "Cookies") extern class Cookies extends js.node.events.EventEmitter<electron.main.Cookies>
{
	/**
	 ...
	 */
	@:optional var session : Bool; }, callback:haxe.Constraints.Function) : Void;
	/**
	 ...
	 */
	@:optional var expirationDate : Float; }, callback:haxe.Constraints.Function) : Void;
	/**
