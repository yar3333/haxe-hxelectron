...
**/
@:require(js, hxelectron) @:jsRequire("electron", "MenuItem") extern class MenuItem
{
	/**
	 ...
	 */
	@:optional var click : haxe.Constraints.Function; /**
	 ...
	 */
	@:optional var type : String; @:optional var label : String; @:optional var sublabel : String; @:optional var accelerator : Accelerator; @:optional var icon : Dynamic; /**
	 ...
	 */
	@:optional var position : String; }) : Void;
}