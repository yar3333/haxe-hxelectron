...
**/
@:require(js, hxelectron) @:jsRequire("electron", "MessagePortMain") extern class MessagePortMain extends js.node.events.EventEmitter<electron.main.MessagePortMain> {
	/**
