...
@:require(js, electron) @:jsRequire("electron", "contentTracing") extern class ContentTracing
{
	 ...
	 */
	static function startRecording(options:{ @:optional var categoryFilter : String; @:optional var traceOptions : String; }, callback:haxe.Constraints.Function) : Void;
	/**
	 ...
	 */
	static function startMonitoring(options:{ @:optional var categoryFilter : String; @:optional var traceOptions : String; }, callback:haxe.Constraints.Function) : Void;
	/**
