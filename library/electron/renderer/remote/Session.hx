...
@:require(js, hxelectron) @:jsRequire("electron", "remote.Session") extern class Session extends js.node.events.EventEmitter<electron.main.Session>
{
	 ...
	 */
	@:optional var storages : Array<String>; /**
	 The types of quotas to clear, can contain: temporary, persistent, syncable.
	 */
	@:optional var quotas : Array<String>; }, ?callback:haxe.Constraints.Function) : Void;
	/**
	 ...
	 */
	@:optional var pacScript : String; /**
	 Rules indicating which proxies to use.
	 */
	@:optional var proxyRules : String; /**
	 Rules indicating which URLs should bypass the proxy settings.
	 */
	@:optional var proxyBypassRules : String; }, callback:haxe.Constraints.Function) : Void;
	/**
	 ...
	 */
	@:optional var offline : Bool; /**
	 RTT in ms. Defaults to 0 which will disable latency throttling.
	 */
	@:optional var latency : Float; /**
	 Download rate in Bps. Defaults to 0 which will disable download throttling.
	 */
	@:optional var downloadThroughput : Float; /**
	 Upload rate in Bps. Defaults to 0 which will disable upload throttling.
	 */
	@:optional var uploadThroughput : Float; }) : Void;
	/**
	 ...
	 */
	@:optional var urlChain : Array<String>; @:optional var mimeType : String; /**
	 ...
	 */
	@:optional var startTime : Float; }) : Void;
	/**
