...
**/
@:require(js, electron) @:jsRequire("electron", "remote.ClientRequest") extern class ClientRequest extends js.node.events.EventEmitter<electron.main.ClientRequest>
{
	/**
