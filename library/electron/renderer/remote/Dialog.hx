...
/**
**/
@:require(js, hxelectron) @:jsRequire("electron", "remote.dialog") extern class Dialog
{
	/**
	 ...
	 */
	static function showOpenDialog(?browserWindow:BrowserWindow, options:{ @:optional var title : String; @:optional var defaultPath : String; /**
	 Custom label for the confirmation button, when left empty the default label will be used.
	 */
	@:optional var buttonLabel : String; @:optional var filters : Array<FileFilter>; /**
	 ...
	 */
	@:optional var message : String; }, ?callback:haxe.Constraints.Function) : Array<String>;
	/**
	 The browserWindow argument allows the dialog to attach itself to a parent window, making it modal. The filters specifies an array of file types that can be displayed, see dialog.showOpenDialog for an example. If a callback is passed, the API call will be asynchronous and the result will be passed via callback(filename)
	 */
	static function showSaveDialog(?browserWindow:BrowserWindow, options:{ @:optional var title : String; @:optional var defaultPath : String; /**
	 Custom label for the confirmation button, when left empty the default label will be used.
	 */
	@:optional var buttonLabel : String; @:optional var filters : Array<FileFilter>; /**
	 ...
	 */
	@:optional var nameFieldLabel : String; /**
	 Show the tags input box, defaults to true.
	 */
	@:optional var showsTagField : Bool; }, ?callback:haxe.Constraints.Function) : String;
	/**
	 ...
	 */
	@:optional var checkboxChecked : Bool; @:optional var icon : NativeImage; /**
	 ...
	 */
	@:optional var normalizeAccessKeys : Bool; }, ?callback:haxe.Constraints.Function) : Int;
	/**
	 ...
	 */
	@:optional var message : String; }, callback:haxe.Constraints.Function) : Void;
}