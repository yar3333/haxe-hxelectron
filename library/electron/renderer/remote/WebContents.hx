...
@:require(js, hxelectron) @:jsRequire("electron", "remote.WebContents") extern class WebContents extends js.node.events.EventEmitter<electron.main.WebContents>
{
	 ...
	 */
	@:optional var medialCapitalAsWordStart : Bool; }) : Void;
	/**
	 ...
	 */
	@:optional var printBackground : Bool; }) : Void;
	/**
	 ...
	 */
	@:optional var landscape : Bool; }, callback:haxe.Constraints.Function) : Void;
	/**
	 ...
	 */
	@:optional var screenPosition : String; /**
	 Set the emulated screen size (screenPosition == mobile)
	 */
	@:optional var screenSize : Size; /**
	 Position the view on the screen (screenPosition == mobile) (default: {x: 0, y: 0})
	 */
	@:optional var viewPosition : Point; /**
	 ...
	 */
	@:optional var modifiers : Array<String>; }) : Void;
	/**
	 ...
	 */
	@:optional var icon : NativeImage; }) : Void;
	 ...
	 */
	@:optional var normal : { @:optional var width : Int; @:optional var height : Int; }; }) : Void;
