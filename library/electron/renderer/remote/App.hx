...
/**
**/
@:require(js, electron) @:jsRequire("electron", "remote.app") extern class App
{
	/**
	 ...
	 */
	static function relaunch(?options:{ @:optional var args : Array<String>; @:optional var execPath : String; }) : Void;
	 ...
	 */
	static function getFileIcon(path:String, ?options:{ @:optional var size : String; }, callback:haxe.Constraints.Function) : Void;
	/**
	 ...
	 */
	@:optional var removedItems : Array<JumpListItem>; };
	/**
	 ...
	 */
	@:optional var password : String; }, callback:haxe.Constraints.Function) : Void;
	/**
	 ...
	 */
	@:optional var args : Array<String>; }) : { @:optional var options : { /**
	 The executable path to compare against. Defaults to process.execPath.
	 */
	@:optional var path : String; /**
	 The command-line arguments to compare against. Defaults to an empty array.
	 ...
	 */
	@:optional var wasOpenedAtLogin : Bool; /**
	 ...
	 */
	@:optional var wasOpenedAsHidden : Bool; /**
	 ...
	 */
	@:optional var restoreState : Bool; };
	/**
	 ...
	 */
	@:optional var openAsHidden : Bool; }, ?path:String, ?args:Array<String>) : Void;
	...
	@:optional var copyright : String; /**
	 Credit information.
	 */
	@:optional var credits : String; /**
	 The app's build version number.
	 */
	@:optional var version : String; }) : Void;
