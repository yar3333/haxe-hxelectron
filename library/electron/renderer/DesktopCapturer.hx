...
/**
**/
@:require(js, hxelectron) @:jsRequire("electron", "desktopCapturer") extern class DesktopCapturer
{
	/**
	 ...
	 */
	@:optional var thumbnailSize : Size; }, callback:haxe.Constraints.Function) : Void;
}