...
@:require(js, electron) @:jsRequire("electron", "NativeImage") extern class NativeImage
{
	function toPNG(?options:{ /**
	 Defaults to 1.0.
	 */
	@:optional var scaleFactor : Float; }) : js.node.Buffer;
	...
	function toDataURL(?options:{ /**
	 Defaults to 1.0.
	 */
	@:optional var scaleFactor : Float; }) : String;
	/**
	 ...
	 */
	@:optional var quality : String; }) : NativeImage;
	 ...
	 */
	@:optional var buffer : js.node.Buffer; /**
	 The data URL containing either a base 64 encoded PNG or JPEG image.
	 */
	@:optional var dataURL : String; }) : Void;
}