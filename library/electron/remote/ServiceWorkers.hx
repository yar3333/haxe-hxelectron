...
**/
@:require(js, hxelectron) @:jsRequire("electron", "remote.ServiceWorkers") extern class ServiceWorkers extends js.node.events.EventEmitter<electron.main.ServiceWorkers> {
	/**
