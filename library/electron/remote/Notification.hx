...
**/
@:require(js, hxelectron) @:jsRequire("electron", "remote.Notification") extern class Notification extends js.node.events.EventEmitter<electron.main.Notification> {
	/**
...
/**
**/
@:require(js, hxelectron) enum abstract NotificationEvent(String) from String to String {
	/**
