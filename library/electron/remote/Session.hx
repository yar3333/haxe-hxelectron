...
**/
@:require(js, hxelectron) @:jsRequire("electron", "remote.Session") extern class Session extends js.node.events.EventEmitter<electron.main.Session> {
	/**
	...
	**/
	@:optional
	var quotas : Array<String>; }):js.lib.Promise<Void>;
	/**
	...
	**/
	@:optional
	var proxyBypassRules : String; }):js.lib.Promise<Void>;
	/**
	...
	**/
	function fetch(input:haxe.extern.EitherType<String, GlobalRequest>, ?init:Dynamic):js.lib.Promise<GlobalResponse>;
	/**
	...
	**/
	function setCertificateVerifyProc(proc:Null<({ var hostname : String; var certificate : Certificate; var validatedCertificate : Certificate; /**
	...
	**/
	function setPermissionRequestHandler(handler:Null<(WebContents, String, Bool -> Dynamic, { /**
	...
	**/
	var isMainFrame : Bool; }) -> Dynamic>):Void;
	/**
	...
	**/
	function setPermissionCheckHandler(handler:Null<(Null<WebContents>, String, String, { /**
	...
	**/
	...
	var requestingUrl : String; /**
		Whether the frame making the request is the main frame
	**/
	var isMainFrame : Bool; }) -> Bool>):Void;
	/**
	...
	**/
	function setDisplayMediaRequestHandler(handler:Null<({ /**
	...
	**/
	var userGesture : Bool; }, ({ @:optional
	var video : haxe.extern.EitherType<{ /**
	...
	**/
	@:optional
	var audio : haxe.extern.EitherType<String, WebFrameMain>; /**
	...
	**/
	@:optional
	var enableLocalEcho : Bool; }) -> Dynamic) -> Dynamic>):Void;
	/**
	...
	**/
	function setDevicePermissionHandler(handler:Null<({ /**
	...
	**/
	var device : haxe.extern.EitherType<HIDDevice, haxe.extern.EitherType<SerialPort, USBDevice>>; }) -> Bool>):Void;
	/**
	...
	**/
	function setUSBProtectedClassesHandler(handler:Null<({ /**
		The current list of protected USB classes. Possible class values include:
	**/
	var protectedClasses : Array<String>; }) -> Array<String>>):Void;
	/**
	...
	**/
	function setBluetoothPairingHandler(handler:Null<({ var deviceId : String; /**
		The type of pairing prompt being requested. One of the following values:
	**/
	var pairingKind : String; var frame : WebFrameMain; /**
	...
	**/
	@:optional
	var pin : Null<String>; }) -> Dynamic) -> Dynamic>):Void;
	/**
	...
	**/
	var allowFileAccess : Bool; }):js.lib.Promise<Extension>;
	/**
	...
	**/
	...
	/**
		...
		**Note:** This API cannot be called before the `ready` event of the `app` module is emitted.
	**/
	function getExtension(extensionId:String):Null<Extension>;
	/**
	...
	**/
	function getStoragePath():Null<String>;
}
