...
**/
@:require(js, hxelectron) @:jsRequire("electron", "remote.TouchBarButton") extern class TouchBarButton extends js.node.events.EventEmitter<electron.main.TouchBarButton> {
	/**
