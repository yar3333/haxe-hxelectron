...
/**
**/
@:require(js, hxelectron) @:jsRequire("electron", "remote.pushNotifications") extern class PushNotifications {
	/**
	...
	**/
	static function registerForAPNSNotifications():js.lib.Promise<Dynamic>;
	/**
