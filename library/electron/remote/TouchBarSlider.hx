...
**/
@:require(js, hxelectron) @:jsRequire("electron", "remote.TouchBarSlider") extern class TouchBarSlider extends js.node.events.EventEmitter<electron.main.TouchBarSlider> {
	/**
...
/**
**/
@:require(js, hxelectron) enum abstract TouchBarSliderEvent(String) from String to String {
