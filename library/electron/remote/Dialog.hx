...
@:require(js, hxelectron) @:jsRequire("electron", "remote.dialog") extern class Dialog {
	...
	**/
	static function showOpenDialogSync(?browserWindow:BrowserWindow, options:{ @:optional
	...
	**/
	static function showSaveDialogSync(?browserWindow:BrowserWindow, options:{ /**
	...
	**/
	static function showSaveDialog(?browserWindow:BrowserWindow, options:{ /**
		The dialog title. Cannot be displayed on some _Linux_ desktop environments.
	**/
	@:optional
	var title : String; /**
