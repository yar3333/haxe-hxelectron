...
**/
@:require(js, hxelectron) @:jsRequire("electron", "remote.WebContents") extern class WebContents extends js.node.events.EventEmitter<electron.main.WebContents> {
	/**
	...
	**/
	function executeJavaScriptInIsolatedWorld(worldId:Int, scripts:Array<WebSource>, ?userGesture:Bool):js.lib.Promise<Dynamic>;
	/**
	...
	**/
	function capturePage(?rect:Rectangle, ?opts:{ /**
	...
	**/
	function getAllSharedWorkers():Array<SharedWorkerInfo>;
	/**
	...
	**/
	function getMediaSourceId(requestWebContents:WebContents):String;
	/**
...
@:require(js, hxelectron) enum abstract WebContentsEvent(String) from String to String {
	...
	**/
	var did_fail_provisional_load : String = "did-fail-provisional-load";
	/**
	...
	**/
	var content_bounds_updated : String = "content-bounds-updated";
	/**
	...
	**/
	var did_create_window : String = "did-create-window";
	/**
	...
	**/
	...
	/**
		...
		Calling `event.preventDefault()` will prevent the navigation.
	**/
	var will_frame_navigate : String = "will-frame-navigate";
	/**
		Emitted when any frame (including main) starts navigating.
	**/
	var did_start_navigation : String = "did-start-navigation";
	/**
	...
	**/
	var will_redirect : String = "will-redirect";
	/**
	...
	**/
	var did_redirect_navigation : String = "did-redirect-navigation";
	/**
	...
	**/
	...
	/**
		...
		This event is not emitted for in-page navigations, such as clicking anchor links or updating the `window.location.hash`. Use `did-navigate-in-page` event for this purpose.
	**/
	var did_frame_navigate : String = "did-frame-navigate";
	/**
	...
	**/
	var render_process_gone : String = "render-process-gone";
	/**
	...
	**/
	var input_event : String = "input-event";
	/**
	...
	**/
	var zoom_changed : String = "zoom-changed";
	/**
	...
	**/
	var devtools_open_url : String = "devtools-open-url";
	/**
	...
	**/
	var audio_state_changed : String = "audio-state-changed";
	/**
	...
	**/
	var did_attach_webview : String = "did-attach-webview";
	/**
	...
	**/
	var preload_error : String = "preload-error";
	/**
