...
**/
@:require(js, hxelectron) @:jsRequire("electron", "remote.MenuItem") extern class MenuItem extends js.node.events.EventEmitter<electron.main.MenuItem> {
	/**
...
/**
**/
@:require(js, hxelectron) enum abstract MenuItemEvent(String) from String to String {
