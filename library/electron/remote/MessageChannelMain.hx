...
**/
@:require(js, hxelectron) @:jsRequire("electron", "remote.MessageChannelMain") extern class MessageChannelMain extends js.node.events.EventEmitter<electron.main.MessageChannelMain> {
	/**
