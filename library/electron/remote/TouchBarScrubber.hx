...
**/
@:require(js, hxelectron) @:jsRequire("electron", "remote.TouchBarScrubber") extern class TouchBarScrubber extends js.node.events.EventEmitter<electron.main.TouchBarScrubber> {
	/**
