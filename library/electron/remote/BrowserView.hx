...
**/
@:require(js, hxelectron) @:jsRequire("electron", "remote.BrowserView") extern class BrowserView extends js.node.events.EventEmitter<electron.main.BrowserView> {
	/**
	...
	**/
	@:optional
	var webPreferences : WebPreferences; }):Void;
...
/**
**/
@:require(js, hxelectron) enum abstract BrowserViewEvent(String) from String to String {
